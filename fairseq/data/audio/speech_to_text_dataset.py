...
from fairseq.data.audio.audio_utils import get_fbank, get_waveform, get_segment_waveform
...
if __name__ == "__main__":
    # data_cfg = {
    #     "audio_root": "/opt/tiger/fairseq/data",
    #     "bpe_tokenizer":{"bpe":"sentencepiece","sentencepiece_model":"/opt/tiger/fairseq/data/spm_unigram10000_st.model"}
    #     "input_channels": 1,
    #     "vocab_file": "/opt/tiger/fairseq/data/spm_unigram10000_st.txt",
    #     "use_audio_input": True
    # }
    data_cfg = S2TDataConfig("data/config.yaml")
