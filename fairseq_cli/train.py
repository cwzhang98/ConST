...
def main(cfg: DictConfig) -> None:
    ...
    # Print args and save config to checkpoint path
    logger.info(cfg)
...
def validate_and_save(
    ...
    do_validate = (
        ...
        or (end_of_epoch and cfg.dataset.validate_interval != 0 and epoch_itr.epoch % cfg.dataset.validate_interval == 0)
        or num_updates >= max_update
        or (
...
def get_valid_stats(
    ...
    if hasattr(checkpoint_utils.save_checkpoint, "best"):
        ...
        is_best = (stats[cfg.checkpoint.best_checkpoint_metric] == stats[key])
    return stats, is_best
